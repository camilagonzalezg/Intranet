<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="RegistrarCorrespondencia.aspx.cs" Inherits="IntranetWeb.RegistrarCorrespondencia" ValidateRequest="false" %>
        ...
        <div class="container-fluid px-5">
            ...
            <div class="bg-light rounded-3 py-5 px-4 px-md-5 mb-5">
                <div class="text-center mb-5">
                    <h1 class="fw-bolder">Ingresar Correspondencia</h1>
                    ...
                    <div class="col-lg-10 col-xl-8">
                        ...
                        <div class="row mb-12">
                            <div class="col-md-12">
                                ...
                                <asp:TextBox ID="DescripcionArchivoTxt" runat="server" CssClass="form-control" TextMode="MultiLine" Rows="5"></asp:TextBox>
                                <asp:RequiredFieldValidator runat="server" ErrorMessage="Debe ingresar la descripción del archivo"
                        ...
                        <div class="mb-4">
                            <div class="col-md-4">
                                <label class="form-label" for="FileUploadControl">Subir Archivo</label>
                        ...
                        <!-- Botón Guardar -->
                        <asp:Button ID="GuardarCorrespondenciaBtn" runat="server" Text="Ingresar Correspondencia"
