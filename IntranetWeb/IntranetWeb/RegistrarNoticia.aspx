            ...
            <div class="bg-light rounded-3 py-5 px-4 px-md-5 mb-5">
                ...
                <div class="row gx-5 justify-content-center">
                    <div class="col-lg-10 col-xl-8">
                        ...
                        <!-- Checkbox para colocar la noticia en el slider del home -->
                        <div class="mb-4">
                            <div class="col-md-4">
                                <label class="form-label" for="ColocarEnSliderCheck">Colocar en slider del home</label>
                                <asp:CheckBox ID="ColocarEnSliderCheck" runat="server" CssClass="form-check-input" />
                            </div>
                        </div>
